...
public class LetsDoBakeryCookingOpenTeachMessage extends ModuleMenuOpenMessage
{
	public LetsDoBakeryCookingOpenTeachMessage(IBuildingModuleView module)
	{
		super(module);
	}

	public LetsDoBakeryCookingOpenTeachMessage(FriendlyByteBuf buffer)
	{
		super(buffer);
	}
