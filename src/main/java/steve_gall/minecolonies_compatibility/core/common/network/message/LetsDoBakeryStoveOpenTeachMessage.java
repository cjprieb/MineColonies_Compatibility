...
public class LetsDoBakeryStoveOpenTeachMessage extends ModuleMenuOpenMessage
{
	public LetsDoBakeryStoveOpenTeachMessage(IBuildingModuleView module)
	{
		super(module);
	}

	public LetsDoBakeryStoveOpenTeachMessage(FriendlyByteBuf buffer)
	{
		super(buffer);
	}
