...
public class LetsDoBakeryBowlOpenTeachMessage extends ModuleMenuOpenMessage
{
	public LetsDoBakeryBowlOpenTeachMessage(IBuildingModuleView module)
	{
		super(module);
	}

	public LetsDoBakeryBowlOpenTeachMessage(FriendlyByteBuf buffer)
	{
		super(buffer);
	}
