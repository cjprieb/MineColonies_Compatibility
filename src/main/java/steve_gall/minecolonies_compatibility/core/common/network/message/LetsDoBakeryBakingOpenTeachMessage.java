...
public class LetsDoBakeryBakingOpenTeachMessage extends ModuleMenuOpenMessage
{
	public LetsDoBakeryBakingOpenTeachMessage(IBuildingModuleView module)
	{
		super(module);
	}

	public LetsDoBakeryBakingOpenTeachMessage(FriendlyByteBuf buffer)
	{
		super(buffer);
	}
