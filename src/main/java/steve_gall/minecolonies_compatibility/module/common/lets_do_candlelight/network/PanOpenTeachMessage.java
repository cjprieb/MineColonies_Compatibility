...
{
	public PanOpenTeachMessage(IBuildingModuleView module)
	{
		super(module);
	}

	public PanOpenTeachMessage(FriendlyByteBuf buffer)
	{
		super(buffer);
	}
	...
	{
		return new PanTeachMenu(windowId, inventory, module);
	}
