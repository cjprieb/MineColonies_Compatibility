...
public class CheeseOpenTeachMessage extends ModuleMenuOpenMessage
{
	public CheeseOpenTeachMessage(IBuildingModuleView module)
	{
		super(module);
	}

	public CheeseOpenTeachMessage(FriendlyByteBuf buffer)
	{
		super(buffer);
	}
	...
	{
		return new CheeseTeachMenu(windowId, inventory, module);
	}
