...
public class CookingTeachMenu extends TeachRecipeMenu<CookingCauldronRecipe>
{
	...
	protected IMenuRecipeValidator<CookingCauldronRecipe> createRecipeValidator()
	{
		return new MenuRecipeValidatorRecipe<>(this.inventory.player.level)
		{
			...
			@Override
			protected boolean test(CookingCauldronRecipe recipe, ServerPlayer player, Container container)
			{
	...
	@Override
	protected void setContainerByTransfer(@NotNull CookingCauldronRecipe recipe, @NotNull CompoundTag payload)
	{
