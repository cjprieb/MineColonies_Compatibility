...
public class ModuleMenuTypes
{
	...
	public static final RegistryObject<MenuType<ApplePressTeachMenu>> APPLE_PRESS = REGISTER.register("lets_do_vinery_apple_press", () -> IForgeMenuType.create(ApplePressTeachMenu::new));
