...
public class BowlCraftingModule extends AbstractCraftingModuleWithExternalWorkingBlocks
{
	public BowlCraftingModule(JobEntry jobEntry)
	{
		super(jobEntry);
	}
	...
	{
		return Component.translatable("minecolonies_compatibility.interaction.no_lets_do_bowl");
	}
