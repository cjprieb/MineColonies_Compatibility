...
public class ModuleCraftingTypes
{
	...
	public static final RegistryObject<CraftingType> BOWL = DeferredRegisterHelper.registerCraftingType(REGISTER, "lets_do_bakery_bowl", id -> new SimpleCraftingType<>(id, RecipeTypeRegistry.CRAFTING_BOWL_RECIPE_TYPE, BowlGenericRecipe::new));
	public static final RegistryObject<CraftingType> BAKING = DeferredRegisterHelper.registerCraftingType(REGISTER, "lets_do_bakery_baking", id -> new SimpleCraftingType<>(id, RecipeTypeRegistry.BAKING_STATION_RECIPE_TYPE, BakingGenericRecipe::new));
